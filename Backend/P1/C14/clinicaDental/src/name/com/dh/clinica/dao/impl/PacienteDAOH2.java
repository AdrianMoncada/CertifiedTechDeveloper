...
import name.com.dh.clinica.dao.configuracion.ConfiguracionJDBC;
    ...
    public Paciente buscar(long id) {
        ...
        try {
            ...
            while(result.next()){
                ...
                String apellidoPaciente = result.getString("apellido");
                ...
                paciente.setFechaingreso(fechaIngresoPaciente);
