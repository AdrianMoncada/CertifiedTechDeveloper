...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Persona persona3 = new Persona("Ramón", "Gonzales", 100);
        Persona persona4 = new Persona("Edgard", "Phillips", 3);
        listaPromedio = new ListaPromedio(Arrays.asList(persona1, persona2, persona3, persona4));
