...
const noticias = [
  ...
  {
    titulo:"Tutora de Digital House Increpa a alumnos por no reconocer a sus compañeros",
    imgUrl: "https://resizer.glanacion.com/resizer/KUh3vpdEtc7wnoZA7RUo8XGuMZo=/768x0/filters:format(webp):quality(80)/cloudfront-us-east-1.images.arcpublishing.com/lanacionar/IN35KNQCHNFRPHPMQGZJMFXKA4.jpg",
    descripcion: "Se capturaron en videollamadas de zoom cómo la Tutoria de Digital House Mailen increpaba a alumnos de la carrera Certified Tech Developer por no reconocer a sus compañeros mediante el widget",
    fecha:"16/03/21",
    tipoNacional: true
...
function renderizarNoticias() {
  ...
  noticias.map( noticia => {
    ...
    `
    <div class="${noticia.tipoNacional} item">
