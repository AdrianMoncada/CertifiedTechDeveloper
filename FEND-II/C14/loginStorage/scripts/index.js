...
const baseDeDatos = {
  ...
  function login(email, pass){
    ...
    if(baseDeDatos.usuarios[i].email == email && baseDeDatos.usuarios[i].password == pass){
      localStorage.setItem("usuario", baseDeDatos.usuarios[i].name);
    }
    }
  }
  ...
  function myFunction(){
    if(localStorage.getItem("NombreUsuario") == null){
      ...
      h1.innerHTML = 
      `
      <p> Bienvenido ${localStorage.getItem("usuario")}</p>
